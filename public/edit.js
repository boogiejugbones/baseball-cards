...
editForm.addEventListener('submit', function(e){
    ...
    const cardNumber = document.getElementById("fcard-number").value.trim();
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    .then(card =>{
        originalCard = card;
        document.getElementById("fname").value = card.playername || '';
        document.getElementById("fteam").value = card.team || '';
        document.getElementById("fyear").value = card.year || '';
        document.getElementById("fposition").value = card.position || '';
        document.getElementById("fcard-number").value = card["card-number"] || '';
    })
    .catch(err => {
